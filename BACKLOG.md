...
- Frontend: dark NLM-branded UI (Playfair Display, #C9A644 gold, #0c0e14 bg); collapsible "Your Business" card; two-column AI Visibility Score (scores left, summary right); "Recommended Improvements" flipable carousel combining recommendations + actions; Analyze/Measure/Improve section only shown pre-submission; debug panel
